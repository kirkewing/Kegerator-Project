...
boolean coldError = true;
boolean hotError = true;
boolean beerError = true;
...
/*
  ...
  } else
  {
    ...
    coldError = coldTempSensor.begin(coldSensorAddress); // Restart Cold Sensor
  }
  ...
  //    lcd.print("H Err "); // Write error to LCD
      hotError = hotTempSensor.begin(hotSensorAddress); // Restart Hot Sensor
    }
  ...
  //    lcd.print("B Err "); // Write error to LCD
      beerError = beerTempSensor.begin(beerSensorAddress); // Restart Beer Sensor
    }
  */
